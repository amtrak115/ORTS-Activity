Santa Fe GA-152 “Kaiser Coal” Gondolas

By Matt Doti
SouthwestChief on the Train-Sim.com Forums
Email SouthwestChief@gmail.com

Shapes by Matt Doti and Ted Curphey
Textures by Matt Doti and Alan Hudson
...
Thank you for downloading this set of Santa Fe gondolas.  
This is my very first 3D train car offering.  
I constructed these gondolas using Train Sim Modeler and textured the models with Paint Shop Pro 8.  

For the trucks and couplers I used Ted Curphey’s outstanding shapes.  
I’m grateful that Ted is willing to share his work to help make our models look better.  

Alan Hudson was an enormous help with updating the textures by adding realistic detailing such as shadows, and metallic reflections.  
Thanks Alan for making these good models into great models. 

The custom and prototypical physics are compliments of Dan Zollner.  
My beta testers for this project included Herb Kelsey, John Reagon, and Alan Hudson.  
...
The yellow and black cars (numbers 74899 and 74963) are suitable for 1966 to the late 1970’s.  
The all black cars (numbers 74912 and 74950) are suitable for the early 1980’s.  
The black and orange cars (numbers 74920 and 74957) are suitable from the mid 1980’s to the present.  
Note, gondola #74920 is technically listed as loaded although the load is only a few scrap ties.
...
I incorporated aggressive levels of detail to help with frames per second.  
However, because these cars use highly detailed trucks and couplers, I do not recommend running more than 40 cars per train if you have an older computer.  
...
The textures are a combination of Alan Hudson and my work.  
...
Following is a list of resources I used for this project:
...
Closing:
********
I hope you enjoy these Santa Fe gondolas.  
They are my first 3D train cars for MSTS.  
I’m grateful to all the friends that helped me with shapes, texturing, physics, and testing.  

This was a long and tedious project and I learned much along the way.  
I encourage you to try 3D modeling.  
Now that I’ve completed one model, I hope to offer more Santa Fe items as the years progress.  
