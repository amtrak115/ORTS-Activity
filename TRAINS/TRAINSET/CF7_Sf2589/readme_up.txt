...
This file contains replacement texture files only, for the complete locomotive model my repaint of Manuel Sanabria`s rounded cab CF7 model is required. It is available in the Train-sim.com library as sf2589.zip.

Included in this zip file:
readme text file (you are reading it now)
file_id.diz  (for use in the train-sim.com library, may discarded)
sf2589up.gif  (for use in the train-sim.com library, may discarded)
sf2589up.jpg  (larger version of the previous, a picture of the locomotive, for preview purposes)
CF7-tga.ace
CF7-tga2.ace  (the new texture files)

What to do?
- unzip the sf2589up.zip in a temporary folder.
- use explorer, and find the sf2589 folder in the trainset folder of your trainsimulator installation.
- make backups of the CF7-tga.ace and CF7-tga2.ace files that are in there, and keep them in a safe place.
- move the texture files in this zip with the same names to the sf2589 folder. (Answer 'yes' to the overwrite question only if you have made backups of the files)
- close explorer, start trainsimulator, select a consist with the CF7 sf2589 in it, and look at the results.
