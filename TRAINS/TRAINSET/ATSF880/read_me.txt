MSTS-ATSF C40-8W #880 is a re-skin of NALW's C40-8W with new engine physics and lighting by Bob Boudoin.Re-skinned using the author's photos. By TKW and Pete Abrams. Renumber and modifications by Bob Boudoin. All the good stuff is by Pete, all the mistakes are by Bob. 
The number boards are not in the correct position for the prototype, and the number font is not perfect, but it is the best I have.
...
1. Unzip the contents of ATSF943 into Trainsim/trains/trainset folder. That's it create a consist and go.
